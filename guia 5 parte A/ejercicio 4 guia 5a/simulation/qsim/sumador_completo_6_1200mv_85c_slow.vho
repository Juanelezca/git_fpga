...
ENTITY 	sumador_completo_sin_procesos IS
    PORT (
	A : IN std_logic;
	B : IN std_logic;
	Cin : IN std_logic;
...
ARCHITECTURE structure OF sumador_completo_sin_procesos IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \SUM~0_combout\ = \Cin~input_o\ $ (\B~input_o\ $ (\A~input_o\))
