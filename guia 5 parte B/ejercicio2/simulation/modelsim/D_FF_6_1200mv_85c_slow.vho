...
-- o_f	=>  Location: PIN_B11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- o_count	=>  Location: PIN_B10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- in_cin	=>  Location: PIN_A5,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL ww_o_count : std_logic;
SIGNAL \clk~inputclkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \o_f~output_o\ : std_logic;
SIGNAL \o_count~output_o\ : std_logic;
...
\o_count~output\ : cycloneive_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\in_cin~input\ : cycloneive_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
